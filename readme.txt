...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="abt.html" style="display: flex; margin-left: -10px;">
...
<!-- // end  -->
    ...
    <footer class="main-footer mt-5">
      <div class="container">
        <div class="row widgets-section align-items-start">
          <div class="footer-logo-social col-12 col-md-auto mb-4 mb-md-0 d-flex flex-column align-items-start pe-md-4" style="min-width:160px;">
            <div class="logo-widget mb-2 mb-md-3 me-md-0">
              <img src="https://i.postimg.cc/d3hYgnfm/SOJAR-Copy.png" alt="Sojar Logo" style="max-width:110px;">
            </div>
            <div class="social-neumorphic mt-2">
              <a href="mailto:info@sojar.in" class="neu-button" aria-label="Mail"><i class="fas fa-envelope"></i></a>
              <a href="https://wa.me/917893939229" class="neu-button" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
              <a href="https://www.linkedin.com/company/sojar-research-services/" class="neu-button" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
              <a href="https://www.facebook.com/sojarresearch/" class="neu-button" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
            </div>
          </div>
          <div class="footer-column col-12 col-md-3 mb-4 mb-md-0">
            <div class="footer-widget mb-2">
              <h6 class="fw-bold mb-2">Quick Links</h6>
              <ul class="list-unstyled mb-0">
                <li><a href="web.html">Home</a></li>
                <li><a href="abt.html">About Us</a></li>
                <li><a href="MenuOfServices.html">Services</a></li>
          ...
          <div class="footer-column col-12 col-md-3 mb-4 mb-md-0">
            <div class="footer-widget mb-2">
              <h6 class="fw-bold mb-2">Services and Solutions</h6>
              <ul class="list-unstyled mb-0">
                ...
                <li><a href="MenuOfServices.html">View All Services</a></li>
              </ul>
            </div>
          </div>
          <div class="footer-column col-12 col-md-3">
            <div class="footer-widget mb-2">
              ...
              <div class="footer-contact mb-2">
                ...
                <div style="font-size:0.97em;">Office 201, Creative's Orchid,<br>Hinjawadi-Punawale Link Road,<br>Beside Lotus Business School,<br>Pune-411033, Maharashtra (India).</div>
                <div class="mt-2"><strong>Phone:</strong> <a href="tel:+917893939229">+91 8793 939 229</a></div>
                <div><strong>Email:</strong> <a href="mailto:info@sojar.in">info@sojar.in</a></div>
              </div>
            </div>
          </div>
        </div>
        <div class="footer-divider my-3"></div>
        <div class="footer-widget--time mb-3">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.019234073964!2d73.7557253148927!3d18.57337068738659!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2b8e2e2e2e2e2%3A0x2e2e2e2e2e2e2e2e!2sSojar%20Research%20Services%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1688999999999!5m2!1sen!2sin" width="100%" height="180" style="border:0; border-radius:10px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div class="footer-divider my-3"></div>
        <div class="text-center pb-2 small" style="color:#bfc8e6;">© 2025 Sojar Research Services Pvt. Ltd. All Rights Reserved</div>
      </div>
    </footer>
...
.navbar-nav {
    margin-right: 0; /* Reset to avoid misalignment */
}
...
.navbar-nav .theme-btn {
    padding: 9px 20px;
    margin-top: 0; /* Removed to align better */
    font-weight: 500;
}
...
.Discover {
    ...
    border-radius: 50px;
    background: linear-gradient(90deg, #fc824d, #7c52fc);
    text-decoration: none;
    color: #ffffff;
    font-size: 14px; /* Reduced for mobile */
    font-weight: 600;
...
.main-footer {
    ...
    color: #ffffff;
    position: relative;
    padding: 30px 0 10px; /* Reduced top padding for compactness */
    width: 100%;
...
.contact-widget ul li {
    ...
    font-size: 13px;
    color: #ffffff;
    text-align: left; /* Left align contact items */
}
...
/* Hide duplicate hamburger icon if present */
.navbar .navbar-brand i.fas.fa-bars {
